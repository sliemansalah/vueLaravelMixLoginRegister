									...
									<ul class="m-topbar__nav m-nav m-nav--inline">
										 ...
										 m-dropdown-persistent="1">
											...
											<div class="m-dropdown__wrapper">
												...
												<div class="m-dropdown__inner">
													<div class="m-dropdown__header m--align-center" style="background: url(../../assets/img/misc/notification_bg.jpg); background-size: cover;">
										...
										<li class="m-nav__item m-topbar__languages m-dropdown m-dropdown--small m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--mobile-full-width" m-dropdown-toggle="click">
											...
											<div class="m-dropdown__wrapper">
												...
												<div class="m-dropdown__inner">
													<div class="m-dropdown__header m--align-center" style="background: url(../../assets/img/misc/quick_actions_bg.jpg); background-size: cover;">
										 ...
										 m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="../../assets/img/users/user4.jpg" class="m--img-rounded m--marginless" alt="" />
												</span>
